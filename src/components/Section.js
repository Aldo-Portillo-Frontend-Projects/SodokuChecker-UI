...
export default function Section({backgroundColor, xmin,ymin,sudoku, setSudoku}) {
  return (
    <div className={`section ${backgroundColor}`}>
        ...
        <Square setSudoku={setSudoku} x={xmin} y={ymin + 2} sudoku={sudoku}/> 
        <Square setSudoku={setSudoku} x={xmin +1} y={ymin} sudoku={sudoku}/>
        <Square setSudoku={setSudoku} x={xmin +1} y={ymin + 1} sudoku={sudoku}/>
